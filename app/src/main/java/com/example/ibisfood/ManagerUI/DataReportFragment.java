...
public class DataReportFragment extends Fragment {
    ...
    ListPostReportAdapter posAdapter;
    List<PostReportFromAdminToManagerModel> postReportFromAdminToManagerModelList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View rootView = inflater.inflate(R.layout.fragment_data_report, container, false);


        auth = FirebaseAuth.getInstance();
        recyclerView = rootView.findViewById(R.id.rv_post_report_list);


        mContext = getContext();
//        inputMinimal = rootView.findViewById(R.id.date_dariTanggalReport);
//        inputMaksimal = rootView.findViewById(R.id.date_sampaiTanggalReport);
//        btnDariTanggal = rootView.findViewById(R.id.CV_dariTanggalReport);
//        btnSampaiTanggal = rootView.findViewById(R.id.CV_sampaiTanggalReport);
//        btnFilterTanggal = rootView.findViewById(R.id.btn_filterDateReport);

        database = FirebaseDatabase.getInstance();
        databaseReference = database.getReference("PostReportWeekly");
...
//        });
    ...
    private void showListener(DataSnapshot snapshot) {
        postReportFromAdminToManagerModelList = new ArrayList<>();
        postReportFromAdminToManagerModelList.clear();
        for(DataSnapshot ds:snapshot.getChildren()){

            PostReportFromAdminToManagerModel post = ds.getValue(PostReportFromAdminToManagerModel.class);
            postReportFromAdminToManagerModelList.add(post);

        }

        posAdapter = new ListPostReportAdapter(mContext,postReportFromAdminToManagerModelList);
